                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text text-center d-grid gap-2"><a href="<?=URL?>/back-end/supprimer-favoris.php?id_annonce=<?=$value['id_ad']?>&id_user=<?=$value['id_user']?>" class="btn btn-danger">retirer des favoris <i class="bi bi-trash"></i></a></p>
                        </div>
                    </div>
                </div>
                <?php } } ?>        
